...
const serviceColors: { [key: string]: string } = {
  ...
  consultation: 'from-orange-500 to-red-600',
  online_report: 'from-purple-500 to-violet-600',
  voice_report: 'from-teal-500 to-cyan-600',
  matching: 'from-yellow-500 to-orange-600',
  gemstone: 'from-indigo-500 to-purple-600',
};
...
export function Services() {
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="animate-pulse">
              <div className="h-4 bg-gray-300 rounded mb-4 max-w-3xl mx-auto"></div>
            </div>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="bg-white rounded-2xl shadow-lg p-6 animate-pulse">
                <div className="w-16 h-16 bg-gray-300 rounded-full mb-6 mx-auto"></div>
  ...
  const getServiceHref = (serviceType: string) => {
    const hrefMap: { [key: string]: string } = {
      ...
      online_report: '/services/online-reports',
      voice_report: '/services/voice-report',
      marriage: '/services/marriage-astrology',
      career: '/services/career-astrology',
      health: '/services/health-astrology',
      matching: '/services/kundli-matching',
      gemstone: '/services/gemstone-consultation',
    };
    return hrefMap[serviceType] || '/services';
  };
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service) => (
            <Link key={service.id} href={getServiceHref(service.service_type)} className="group">
              <div className="bg-white rounded-2xl shadow-lg p-6 h-full hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
                <div className={`w-16 h-16 bg-gradient-to-r ${serviceColors[service.service_type] || 'from-orange-500 to-red-600'} rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  <div className="text-white">
                    {serviceIcons[service.service_type] || serviceIcons.consultation}
                  </div>
                </div>
