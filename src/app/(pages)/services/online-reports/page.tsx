          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <img src="/images/whatsapp/consultation-1.jpg" alt="Step 1" className="w-20 h-20 rounded-full object-cover" />
              </div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-r from-red-400 to-red-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <img src="/images/whatsapp/consultation-2.jpg" alt="Step 2" className="w-20 h-20 rounded-full object-cover" />
              </div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-r from-purple-400 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <img src="/images/whatsapp/consultation-3.jpg" alt="Step 3" className="w-20 h-20 rounded-full object-cover" />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <a href="/book-appointment" className="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors">Order Now</a>
            </div>
